...
class Camera2BasicFragment : Fragment(), View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
     ...
     */
    private val mOnImageAvailableListener = ImageReader.OnImageAvailableListener { reader -> mBackgroundHandler!!.post(ImageSaver(reader.acquireNextImage(), mFile as File)) }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById(R.id.use_picture_button).setOnClickListener(this)
    ...
    override fun onClick(view: View) {
        when (view.id) {
            ...
            R.id.use_picture_button -> {
                if (mFile != null) {
                    activity.intent.putExtra(INTENT_EXTRA_FILE_NAME, mFile!!.absolutePath)
                    activity.setResult(RESULT_OK, activity.intent)
                } else {
                    activity.setResult(RESULT_FAIL)
                }
                activity.finish()
            }
        }
